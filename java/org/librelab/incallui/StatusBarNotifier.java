...
import static org.librelab.contacts.common.compat.CallCompat.Details.PROPERTY_ENTERPRISE_CALL;
import static org.librelab.dialer.app.DevicePolicyResources.NOTIFICATION_INCOMING_WORK_CALL_TITLE;
import static org.librelab.dialer.app.DevicePolicyResources.NOTIFICATION_ONGOING_WORK_CALL_TITLE;
import static org.librelab.dialer.app.DevicePolicyResources.NOTIFICATION_WIFI_WORK_CALL_LABEL;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_ACCEPT_VIDEO_UPGRADE_REQUEST;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_ANSWER_VIDEO_INCOMING_CALL;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_ANSWER_VOICE_INCOMING_CALL;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_DECLINE_INCOMING_CALL;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_DECLINE_VIDEO_UPGRADE_REQUEST;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_HANG_UP_ONGOING_CALL;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_TURN_OFF_SPEAKER;
import static org.librelab.incallui.NotificationBroadcastReceiver.ACTION_TURN_ON_SPEAKER;
...
import org.librelab.contacts.common.ContactsUtils;
import org.librelab.contacts.common.ContactsUtils.UserType;
import org.librelab.dialer.R;
import org.librelab.dialer.common.Assert;
import org.librelab.dialer.common.LogUtil;
import org.librelab.dialer.contactphoto.BitmapUtil;
import org.librelab.dialer.contacts.ContactsComponent;
import org.librelab.dialer.lettertile.LetterTileDrawable;
import org.librelab.dialer.lettertile.LetterTileDrawable.ContactType;
import org.librelab.dialer.notification.NotificationChannelId;
import org.librelab.dialer.theme.base.ThemeComponent;
import org.librelab.dialer.util.DrawableConverter;
import org.librelab.incallui.ContactInfoCache.ContactCacheEntry;
import org.librelab.incallui.ContactInfoCache.ContactInfoCacheCallback;
import org.librelab.incallui.InCallPresenter.InCallState;
import org.librelab.incallui.async.PausableExecutor;
import org.librelab.incallui.audiomode.AudioModeProvider;
import org.librelab.incallui.call.CallList;
import org.librelab.incallui.call.DialerCall;
import org.librelab.incallui.call.DialerCallListener;
import org.librelab.incallui.call.TelecomAdapter;
import org.librelab.incallui.call.state.DialerCallState;
import org.librelab.incallui.ringtone.DialerRingtoneManager;
import org.librelab.incallui.ringtone.InCallTonePlayer;
import org.librelab.incallui.ringtone.ToneGeneratorFactory;
import org.librelab.incallui.videotech.utils.SessionModificationState;
