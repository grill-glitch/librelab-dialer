...
package org.librelab.incallui.incalluilock;

/**
 * Prevents the {@link org.librelab.incallui.InCallActivity} from auto-finishing where there are no
 * calls left. Acquired through {@link
 * org.librelab.incallui.InCallPresenter#acquireInCallUiLock(String)}. Example: when a dialog is
