...
import org.librelab.incallui.InCallPresenter.InCallOrientationListener;
...
import org.librelab.incallui.call.InCallVideoCallCallbackNotifier;
import org.librelab.incallui.call.InCallVideoCallCallbackNotifier.SurfaceChangeListener;
...
import org.librelab.incallui.videosurface.protocol.VideoSurfaceDelegate;
 ...
 * org.librelab.incallui.VideoCallPresenter} performs the following negotiation with the telephony
 * layer:
 *
 * <ul>
