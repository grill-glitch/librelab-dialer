...
import org.librelab.contacts.common.list.ViewPagerTabs;
import org.librelab.dialer.R;
import org.librelab.dialer.callstats.CallStatsFragment;
import org.librelab.dialer.callstats.DoubleDatePickerDialog;
...
public class CallLogActivity extends TransactionSafeActivity implements
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (item.getItemId() == android.R.id.home) {
      final Intent intent = new Intent("org.librelab.dialer.main.impl.MAIN");
