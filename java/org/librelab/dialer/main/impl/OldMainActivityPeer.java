...
package org.librelab.dialer.main.impl;
...
import org.librelab.dialer.app.MainComponent;
import org.librelab.dialer.app.calllog.CallLogAdapter;
import org.librelab.dialer.app.calllog.CallLogFragment;
import org.librelab.dialer.app.calllog.CallLogFragment.CallLogFragmentListener;
import org.librelab.dialer.app.calllog.CallLogNotificationsService;
import org.librelab.dialer.app.calllog.VisualVoicemailCallLogFragment;
import org.librelab.dialer.common.FragmentUtils.FragmentUtilListener;
import org.librelab.dialer.common.LogUtil;
import org.librelab.dialer.common.concurrent.DialerExecutorComponent;
import org.librelab.dialer.common.concurrent.SupportUiListener;
import org.librelab.dialer.contactsfragment.ContactsFragment;
import org.librelab.dialer.contactsfragment.ContactsFragment.Header;
import org.librelab.dialer.contactsfragment.ContactsFragment.OnContactSelectedListener;
import org.librelab.dialer.database.CallLogQueryHandler;
import org.librelab.dialer.database.Database;
import org.librelab.dialer.dialpadview.DialpadFragment;
import org.librelab.dialer.dialpadview.DialpadFragment.DialpadListener;
import org.librelab.dialer.dialpadview.DialpadFragment.LastOutgoingCallCallback;
import org.librelab.dialer.dialpadview.DialpadFragment.OnDialpadQueryChangedListener;
import org.librelab.dialer.i18n.LocaleUtils;
import org.librelab.dialer.main.MainActivityPeer;
import org.librelab.dialer.main.impl.bottomnav.BottomNavBar;
import org.librelab.dialer.main.impl.bottomnav.BottomNavBar.OnBottomNavTabSelectedListener;
import org.librelab.dialer.main.impl.bottomnav.BottomNavBar.TabIndex;
import org.librelab.dialer.main.impl.bottomnav.MissedCallCountObserver;
import org.librelab.dialer.main.impl.toolbar.MainToolbar;
import org.librelab.dialer.postcall.PostCall;
import org.librelab.dialer.promotion.Promotion;
import org.librelab.dialer.promotion.Promotion.PromotionType;
import org.librelab.dialer.promotion.PromotionComponent;
import org.librelab.dialer.searchfragment.list.NewSearchFragment.SearchFragmentListener;
import org.librelab.dialer.smartdial.util.SmartDialPrefix;
import org.librelab.dialer.speeddial.SpeedDialFragment;
import org.librelab.dialer.storage.StorageComponent;
import org.librelab.dialer.telecom.TelecomUtil;
import org.librelab.dialer.theme.base.Theme;
import org.librelab.dialer.theme.base.ThemeComponent;
import org.librelab.dialer.util.PermissionsUtil;
import org.librelab.dialer.util.TransactionSafeActivity;
import org.librelab.dialer.voicemailstatus.VisualVoicemailEnabledChecker;
import org.librelab.dialer.voicemailstatus.VoicemailStatusHelper;
