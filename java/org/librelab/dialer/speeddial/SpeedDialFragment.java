...
package org.librelab.dialer.speeddial;
...
import org.librelab.dialer.callintent.CallInitiationType;
...
import org.librelab.dialer.common.concurrent.DefaultFutureCallback;
...
import org.librelab.dialer.common.concurrent.ThreadUtil;
import org.librelab.dialer.historyitemactions.DividerModule;
import org.librelab.dialer.historyitemactions.HistoryItemActionBottomSheet;
import org.librelab.dialer.historyitemactions.HistoryItemActionModule;
import org.librelab.dialer.historyitemactions.HistoryItemBottomSheetHeaderInfo;
import org.librelab.dialer.historyitemactions.IntentModule;
import org.librelab.dialer.precall.PreCall;
import org.librelab.dialer.shortcuts.ShortcutRefresher;
import org.librelab.dialer.speeddial.ContextMenu.ContextMenuItemListener;
import org.librelab.dialer.speeddial.FavoritesViewHolder.FavoriteContactsListener;
import org.librelab.dialer.speeddial.HeaderViewHolder.SpeedDialHeaderListener;
import org.librelab.dialer.speeddial.SuggestionViewHolder.SuggestedContactsListener;
import org.librelab.dialer.speeddial.database.SpeedDialEntry.Channel;
import org.librelab.dialer.speeddial.draghelper.SpeedDialItemTouchHelperCallback;
import org.librelab.dialer.speeddial.draghelper.SpeedDialLayoutManager;
import org.librelab.dialer.speeddial.loader.SpeedDialUiItem;
import org.librelab.dialer.speeddial.loader.UiItemLoaderComponent;
import org.librelab.dialer.util.IntentUtil;
import org.librelab.dialer.util.PermissionsUtil;
import org.librelab.dialer.widget.EmptyContentView;
import org.librelab.dialer.widget.EmptyContentView.OnEmptyViewActionButtonClickedListener;
