...
package org.librelab.voicemail.impl.scheduling;
...
import org.librelab.dialer.constants.ScheduledJobIds;
import org.librelab.voicemail.impl.Assert;
import org.librelab.voicemail.impl.VvmLog;
import org.librelab.voicemail.impl.scheduling.Tasks.TaskCreationException;
...
public class TaskSchedulerJobService extends JobService implements TaskExecutor.Job {
  ...
  private static final String EXPECTED_JOB_ID =
      "org.librelab.voicemail.impl.scheduling.TaskSchedulerJobService.EXPECTED_JOB_ID";

  private static final String NEXT_JOB_ID =
      "org.librelab.voicemail.impl.scheduling.TaskSchedulerJobService.NEXT_JOB_ID";
